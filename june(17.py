...
# Load dataset
df = pd.read_csv("stores_sales_forecasting.csv", encoding='ISO-8859-1', parse_dates=["Order Date"])
df = df.head(50)
# Set date as index
...
# Create lag features from 'Sales'
...
for _ in range(12):
    ...
    # Shift lags: lag_12 ← lag_11 ← ... ← lag_1
    ...
    # Append new row to last_known DataFrame
